...
class CustomDataGenerator(Sequence):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(len(batch_x)):
            batch_x[i] = self.augment.random_transform(batch_x[i])
...
# create custom generator that repeats the data
train_generator = CustomDataGenerator(X_train, y_train, batch_size=batch_size_val, augmentations=augmentations)
train_steps = len(X_train) // batch_size_val
